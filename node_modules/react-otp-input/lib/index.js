    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', _extends({
          style: Object.assign({ width: '1em', textAlign: 'center' }, inputStyle, focus && isStyleObject(focusStyle) && focusStyle, isDisabled && isStyleObject(disabledStyle) && disabledStyle, hasErrored && isStyleObject(errorStyle) && errorStyle),
...
var OtpInput = function (_Component) {
  ...
  function OtpInput() {
    ...
    return _ret2 = (_temp2 = (_this3 = _possibleConstructorReturn(this, (_ref2 = OtpInput.__proto__ || Object.getPrototypeOf(OtpInput)).call.apply(_ref2, [this].concat(args))), _this3), _this3.state = {
      activeInput: 0,
      otp: []
    }, _this3.getOtp = function () {
      _this3.props.onChange(_this3.state.otp.join(''));
      ...
      var _this3$state = _this3.state,
          activeInput = _this3$state.activeInput,
          otp = _this3$state.otp;
      ...
      var _this3$state2 = _this3.state,
          activeInput = _this3$state2.activeInput,
          otp = _this3$state2.otp;
      ...
      var _this3$state3 = _this3.state,
          activeInput = _this3$state3.activeInput,
          otp = _this3$state3.otp;
  ...
  _createClass(OtpInput, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: Object.assign({ display: 'flex' }, isStyleObject(containerStyle) && containerStyle), className: !isStyleObject(containerStyle) && containerStyle },
        this.renderInputs()
      );
    }
  }]);
